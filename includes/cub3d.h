...
int							extract_save_map(char *line,
								t_config_data *onfig_data);
...
char						**ft_split(t_config_data *config_data,
								char const *s, char c);
char						*ft_strdup(t_config_data *config_data,
								const char *str);
size_t						ft_strlen(const char *str);
int							ft_strncmp(const char *first, const char *second,
								size_t length);
char						*ft_strnjoin(t_config_data *config_data, char *s1,
								char *s2, int byte_nbr);
char						*ft_strnstr(const char *s1, const char *s2,
								size_t len);
char						*ft_strtrim(t_config_data *config_data,
								char const *s1, char const *set);
char						*ft_substr(t_config_data *config_data,
